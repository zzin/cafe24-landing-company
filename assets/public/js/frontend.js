...
/***/ "./assets/src/js/components/formValidator.js":
/*!***************************************************!*\
  !*** ./assets/src/js/components/formValidator.js ***!
  \***************************************************/
...
var FormValidator = /*#__PURE__*/function () {
  function FormValidator(form, fields, btn, action) {
  ...
  _createClass(FormValidator, [{
    ...
    value: function validateFields(field) {
      ...
      if (field.type === 'tel' && field.value.trim() !== '') {
        var _re = /^\+?\d{1,4}?[-.\s]?\(?\d{1,3}?\)?[-.\s]?\d{1,4}[-.\s]?\d{1,4}[-.\s]?\d{1,9}$/;
        if (_re.test(field.value)) {
          this.setStatus(field, null, 'success');
        } else {
          this.chkValid++;
    ...
    value: function checkAllInput() {
      ...
      this.fields.forEach(function (field) {
        ...
        if (input.type === 'checkbox' && !input.checked) {
          _this2.chkValid++;
          _this2.setStatus(input, input.dataset.message, 'error');
        }
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _initBanner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./initBanner */ "./assets/src/js/components/initBanner.js");
/* harmony import */ var _initDark__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./initDark */ "./assets/src/js/components/initDark.js");
/* harmony import */ var _initDefault__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./initDefault */ "./assets/src/js/components/initDefault.js");
/* harmony import */ var _initFaq__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./initFaq */ "./assets/src/js/components/initFaq.js");
/* harmony import */ var _initFlickity__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./initFlickity */ "./assets/src/js/components/initFlickity.js");
/* harmony import */ var _initHero__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./initHero */ "./assets/src/js/components/initHero.js");
...
/***/ "./assets/src/js/components/initBanner.js":
/*!************************************************!*\
  !*** ./assets/src/js/components/initBanner.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitBanner = function InitBanner() {
  var init = function init() {
    var figureBanner = document.querySelector('.figure-banner');
    if (figureBanner) {
...
/***/ "./assets/src/js/components/initDark.js":
/*!**********************************************!*\
  !*** ./assets/src/js/components/initDark.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var InitDark = function InitDark() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitDark);

/***/ }),

/***/ "./assets/src/js/components/initDefault.js":
/*!*************************************************!*\
  !*** ./assets/src/js/components/initDefault.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitDefault = function InitDefault() {
  var initGlobal = function initGlobal() {
    ...
    var handleSizeChange = function handleSizeChange(mql) {
      if (mql.matches) {
        // mobile size
  ...
  var initQuickGo = function initQuickGo() {
    gsap__WEBPACK_IMPORTED_MODULE_1__["default"].utils.toArray('#primary-menu .menu-item a').forEach(function (link) {
...
/***/ "./assets/src/js/components/initFaq.js":
/*!*********************************************!*\
  !*** ./assets/src/js/components/initFaq.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitFaq = function InitFaq() {
  var makeMore = function makeMore(target) {
    var parentItem = target.closest('.item');
    var answer = parentItem.querySelector('.answer');
    parentItem.style.setProperty('--h', parentItem.clientHeight + answer.clientHeight + 'px');
    parentItem.classList.toggle('is-active');
  };
  var faqs = document.querySelectorAll('.faq--ul .btn--more');
  if (faqs) {
    Array.from(faqs).forEach(function (el) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitFaq);

/***/ }),

/***/ "./assets/src/js/components/initFlickity.js":
/*!**************************************************!*\
  !*** ./assets/src/js/components/initFlickity.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitFlickity = function InitFlickity() {
  var barWidth = 0;
  var totalSlide = 0;
  var flickityBtnPrev, flickityBtnNext;
  var flickityBtns;
  var makeLineBar = function makeLineBar(num) {
    var bar = document.querySelector('.flickity-nav-line .bar');
    totalSlide = num;
    barWidth = 1 / num * 100;
    bar.style.width = barWidth + '%';
  };
  var moveLineBar = function moveLineBar(num) {
    var bar = document.querySelector('.flickity-nav-line .bar');
    bar.style.left = barWidth * num + '%';
    flickityBtns.forEach(function (el) {
  ...
  var makeControlBtn = function makeControlBtn(el) {
    var btns = el.querySelectorAll('.control .btn');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var components = document.querySelectorAll('[data-component="flickity"]');
    if (components) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitFlickity);

/***/ }),

/***/ "./assets/src/js/components/initGlobal.js":
/*!************************************************!*\
  !*** ./assets/src/js/components/initGlobal.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./assets/src/js/components/initHero.js":
/*!**********************************************!*\
  !*** ./assets/src/js/components/initHero.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitHero = function InitHero() {
  ...
  var titleUp = heroSlogan.querySelector('.title-up');
  var titleH2 = heroSlogan.querySelector('.title-h2');
  var titleDown = heroSlogan.querySelector('.title-down');
  var menuItems = document.querySelectorAll('.menu-item');
  var siteHeaerBranding = document.querySelector('.site-header--branding');
  var init = function init() {
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(heroSlogan, {
      xPercent: -100,
      autoAlpha: 0
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([titleUp, titleH2, titleDown], {
      autoAlpha: 0,
      xPercent: 5
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([siteHeaerBranding, menuItems], {
      y: -20,
      autoAlpha: 0
    });
...
/***/ "./assets/src/js/components/initMarquee.js":
/*!*************************************************!*\
  !*** ./assets/src/js/components/initMarquee.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitMarquee = function InitMarquee() {
  var init = function init() {
    var marquee = document.querySelector('[data-component="marquee"]');
    if (!marquee) {
      return;
    }
    ...
    var marqueContentClone = marqueeContent.cloneNode(true);
    ...
    var playMarquee = function playMarquee() {
      ...
      tween = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(marquee.children, {
        x: 0
      }, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitMarquee);

/***/ }),

/***/ "./assets/src/js/components/initNavigation.js":
/*!****************************************************!*\
  !*** ./assets/src/js/components/initNavigation.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var InitNavigation = function InitNavigation() {
  ...
  var menuPrimaryContainer = document.querySelector('.menu-primary-container');
  button.addEventListener('click', function () {
    if (document.documentElement.classList.contains('size-mobile')) {
      ...
      if (button.getAttribute('aria-expanded') === 'true') {
        ...
        // out
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(menuPrimaryContainer, {
          duration: 0.4,
          top: '110vh',
          ease: 'power2.inOut'
        });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InitNavigation);

/***/ }),

/***/ "./assets/src/js/components/initRequest.js":
/*!*************************************************!*\
  !*** ./assets/src/js/components/initRequest.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _formValidator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formValidator */ "./assets/src/js/components/formValidator.js");
/* harmony import */ var _initGlobal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./initGlobal */ "./assets/src/js/components/initGlobal.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var InitRequest = /*#__PURE__*/function () {
  function InitRequest() {
    _classCallCheck(this, InitRequest);
    this.requestForm = document.getElementById('requestForm');
    if (this.requestForm !== null) {
      this.requestFormSubmit = document.querySelector('#requestForm .btn--submit');
      this.events();
    }
  }
  _createClass(InitRequest, [{
    key: "events",
    value: function events() {
      var fields = ['company', 'name', 'tel', 'email', 'comment', 'agree'];
      var validator = new _formValidator__WEBPACK_IMPORTED_MODULE_0__["default"](this.requestForm, fields, this.requestFormSubmit, this.saveRequest);
    ...
    value: function saveRequest() {
      ...
      var serialized = (0,_initGlobal__WEBPACK_IMPORTED_MODULE_1__.serialize)(formData);
      var data = {
        action: 'saveRequest',
      ...
      $.ajax({
        ...
        beforeSend: function beforeSend(xhr) {
          var changeBtn = document.querySelector('#requestForm .btn--submit');
        ...
        error: function error(request, status, _error) {
          console.log('code = ' + request.status + ' message = ' + request.responseText + ' error = ' + _error); // 실패 시 처리
        }
      });
    }
  }]);
